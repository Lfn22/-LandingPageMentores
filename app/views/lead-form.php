...
<?php else: ?>
    ...
    ?>
    <form id="lead-form" data-lead-form action="api/lead.php" method="post" novalidate>
        ...
        <div class="field">
            <label>
                ...
                <?= e($site['lgpd']['consent_text']) ?>
                <a href="<?= e($site['lgpd']['policy_url']) ?>">Política de Privacidade</a>
            </label>
